    ...
    try {
      ...
      if (_currentStreamUrl != null && _currentStreamUrl!.isNotEmpty) {
        ...
        if (_videoPlayerController != null) {
          print('TvFavoriteScreen - Disposing old controller before resume reconnection...');
      ...
      if (_videoPlayerController != null) {
        if (disposeOldController) {
          ...
          try {
            ...
            await _videoPlayerController!.dispose();
            print('TvFavoriteScreen - Controller disposed successfully');
          } catch (e) {
            print('TvFavoriteScreen - Controller already disposed or error during dispose: $e');
          }
          _videoPlayerController = null;
        } else {
          // RESUME: Garbage Collector Strategie um Race Conditions zu vermeiden
